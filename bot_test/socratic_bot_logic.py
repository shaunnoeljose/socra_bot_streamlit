...
import json # Moved this import to the top to be globally accessible
from langgraph.graph.message import add_messages
# Import MemorySaver for persistent memory
...
# except Exception:
#     pass
# logger.info("Socratic LangGraph workflow compiled with Supervisor and MemorySaver.") # Uncomment when logger is ready
